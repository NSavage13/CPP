...
int main()                                          //Line 4
{
    ...
    orderedLinkedList<int> list2;                   //Line 5
                     //Line 6
    int num;                                        //Line 7
    ...
    {                                               //Line 11
        list2.insertLast(num);                      //Line 12
        cin >> num;                                 //Line 13
    }                                               //Line 14
    cout << endl;                                   //Line 15
    list2.print();
    cout << endl;
    cout <<"Get the 2nd element-> "<< list2.getKthElement(2) << endl;
    cout << "Delete the 1st element- > ";
    list2.deleteKthElement(1);
    list2.print();
    cout << endl;
...
//    cout << endl;                                   //Line 27
//
//    list2.deleteKthElement(4);                         //Line 28
//
